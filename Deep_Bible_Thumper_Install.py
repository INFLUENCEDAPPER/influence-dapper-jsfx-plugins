"""
INFLUENCE DAPPER DEEP BIBLE THUMPER - installer & metadata writer.
...
LEXICON = [
    "INFLUENCE", "DAPPER", "BIBLE", "THUMPER",
    "THUMP", "RUMP", "COM", "DEEP", "2026"
]
...
METADATA = {
    "title":     "INFLUENCE DAPPER DEEP BIBLE THUMPER",
    "author":    "INFLUENCEDAPPER.COM",
    "publisher": "INFLUENCE DAPPER",
    "copyright": "INFLUENCE DAPPER COM 2026",
    "comment":   "INFLUENCE DAPPER BIBLE THUMPER THUMP RUMP COPYRIGHT 2026 COM CC-NC-4.0 INTL",
    "tags":      autofill_pool(),
...
JSFX_FILENAME = "DeepBibleThumper.jsfx"
...
def install(jsfx_source: Path):
    ...
    (dest_dir / "DeepBibleThumper.metadata.json").write_text(
        json.dumps(METADATA, indent=2), encoding="utf-8"
    )
    print(f"Installed: {dest}")
    print("In REAPER: FX browser -> JS -> InfluenceDapper -> DeepBibleThumper")
